/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6db1e8c44647f67af59120f740508c69)
// Runtime types generated with workerd@1.20260815.1 2026-08-20 nodejs_compat
interface __BaseEnv_Env {
	AUDIO: R2Bucket;
	DB: D1Database;
	CLOUDFLARE_ACCOUNT_ID: "0c8c9a41f55c7f43aafb16c63932e723";
	DEEPSEEK_API_KEY: string;
	DEEPSEEK_BASE_URL: string;
	DEEPSEEK_MODEL: string;
	TTS_MOCK_URL: string;
	WORDS_MOCK_URL: string;
	LESSON_WORKFLOW: Workflow<Parameters<import("./src/worker").LessonWorkflow['run']>[0]['payload']>;
	PREWARM_WORKFLOW: Workflow<Parameters<import("./src/worker").PrewarmWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "DEEPSEEK_API_KEY" | "DEEPSEEK_BASE_URL" | "DEEPSEEK_MODEL" | "TTS_MOCK_URL" | "WORDS_MOCK_URL">> {}
}
